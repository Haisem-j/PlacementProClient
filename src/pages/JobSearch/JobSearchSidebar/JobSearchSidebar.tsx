...
const JobSearchSidebar = () => {
  const [remoteJob, setRemoteJob] = React.useState<boolean>(false);

  return (
    <aside className="h-screen sticky top-0 mb-8 md:mb-0 md:w-64 lg:w-72 md:ml-12 lg:ml-20 md:shrink-0 md:order-1">
      <div>
